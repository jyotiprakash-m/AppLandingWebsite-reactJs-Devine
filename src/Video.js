...
function Video() {
    return (
        ...
        <section class="text-gray-600 body-font">
            ...
            <h1 class="text-3xl text-gray-900 mb-5 heading">Video demo</h1>      
                <div class="lg:w-3/6 md:w-4/6 w-5/6  h-96 mb-10 object-cover object-center rounded" >
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/tgbNymZ7vqY" title="Working of Devine">
                    </iframe>
                </div>
